...
from views import get_animals_by_location, get_animals_by_status, get_customers_by_email, get_employees_by_location
...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def parse_url(self, path): #this is for explorer chapters, book 2
    ...
    # def parse_url(self, path): #pre explorer chapters book 2
    ...
    def do_GET(self):
        ...
        #     elif query_params.get('location_id') and resource == 'animals':
        #         response = get_animals_by_location(query_params['location_id'][0])
        #     elif query_params.get('location_id') and resource == 'employees':
